  ...
  const myHeaders = {
      ...
      $.ajax({
          ...
          success: function(value){
             ...
             $('.userDP').attr("src", value.data.compte.profile_picture+'?'+performance.now());
            ...
            $.ajax({
                ...
                success: function(){
                    ...
                    $.ajax({
                        ...
                        dataType: "json",
                        success: function(value){
                            document.getElementById('ifr').setAttribute('src', value.data.compte.cv+'?token='+myToken);
                           let profDat = JSON.stringify(value);
                           localStorage.setItem("profdat", profDat);
                           location.reload();
                        }
